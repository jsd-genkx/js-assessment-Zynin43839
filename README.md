...
เช็กว่า: 1) ออกนอกขอบเขตสนาม หรือไม่ 2) ตกหลุม ('O') หรือไม่ 3) เจอหมวก ('^') แล้วหรือยัง
****หากมีเหตุการณ์ใดเกิดขึ้น จะพิมพ์ข้อความแจ้งเตือน และจบเกมด้วย process.exit() 
      4) แจ้งเตือนเมื่อผู้เล่นอยู่ริมสนาม
      5) เพิ่มเงื่อนไขตรวจสอบว่าตำแหน่งของผู้เล่นอยู่ที่ ขอบสนาม หรือไม่ เช่น อยู่แถวแรก (y === 0), คอลัมน์สุดท้าย (x === width - 1) เป็นต้น หากอยู่ริมสนาม ให้แสดงข้อความแจ้งเตือน เพื่อเตือนให้ผู้เล่นระวัง

3. อัปเดตสนาม เมื่อเดินสำเร็จ ให้แทนตำแหน่งใหม่ด้วย "*" เพื่อแสดงว่าเป็นเส้นทางที่เดินผ่านมาแล้ว 
จากนั้นแสดงสนามใหม่อีกครั้ง

4. ทำงานต่อเนื่องเกมจะวนลูปรับคำสั่งใหม่ไปเรื่อยๆ จนกว่าจะเกิดเหตุการณ์จบเกม